...
{cat:"addons",price:"3.50€",unit:"250 g",img:"images/addon-focaccia.jpg",t:{me:{n:"Фокача"},en:{n:"Focaccia"},ru:{n:"Фокачча"},fr:{n:"Focaccia"},de:{n:"Focaccia"},it:{n:"Focaccia"},es:{n:"Focaccia"},tr:{n:"Focaccia"}}},
...
const DRINKS = [
/* ---- КАФА ---- */
D("coffee","arabica","2.40€","0.03 l","Биолошка органика","Biological organic","Бленд одабраних арабика из Бразила; арома и укус бадема и чоколаде, кремаста структура","Blend of selected Arabicas from Brazil; almond & chocolate aroma, creamy body"),
D("coffee","arabica","2.00€","0.03 l","Кремозо","Cremoso","Мјешавина кафе из Вијетнама и Бразила; густа тамна крема, укус љешника и карамеле (арабика 50%, робуста 50%)","Vietnam/Brazil blend; dense dark crema, hazelnut & caramel (arabica 50%, robusta 50%)"),
...
/* ---- ЖЕСТОКА ПИЋА ---- */
D("spirits","rakija","4.60€","0.03 l","Дуња","Quince"),
D("spirits","rakija","4.60€","0.03 l","Кајсија","Apricot"),
D("spirits","rakija","4.60€","0.03 l","Виљамовка","Williams pear"),
D("spirits","rakija","4.60€","0.03 l","Шљива","Plum"),
D("spirits","rakija","4.60€","0.03 l","Завет Медица","Zavet Medica"),
D("spirits","rakija","4.40€","0.03 l","Шљива Зарић","Plum Zarić"),
D("spirits","rakija","4.60€","0.03 l","Зора Дуња","Zora Dunja"),
D("spirits","premiumrakija","5.90€","0.03 l","Завет 5 г. — специјална едиција","Zavet 5 Y.O. Special Edition","Ракија од шљиве, потпуно зрели плодови сорти Чачанска родна и Чачанска лепотица","Plum brandy from fully ripe Čačanska Rodna and Čačanska Lepotica"),
D("spirits","premiumrakija","14.00€","0.03 l","Завет 10 г. — лимитирана едиција","Zavet 10 Y.O. Limited Edition","Ручно брани плодови сорти Пожегача, Црвена ранка и Чачанска лепотица","Hand-picked Požegača, Crvena Ranka and Čačanska Lepotica"),
D("spirits","premiumrakija","20.00€","0.03 l","Завет 190 — лимитирана едиција 15 г.","Zavet 190 Limited Edition 15 Y.O.","15 година у храстовом бурету, серија од 1200 боца (Пожегача, Црвена ранка, Чачанска родна)","Aged 15 years in oak, 1200-bottle series (Požegača, Crvena Ranka, Čačanska Rodna)"),
...
/* ---- ВИНСКА КАРТА ---- */
D("wine","glass","6.50€","0.15 l","Prosecco Extra Dry — Scanavino, Piemonte, IT (Glera)","Prosecco Extra Dry — Scanavino, Piemonte, IT (Glera)"),
...
D("wine","sparkling","26.00€","0.75 l","Prosecco Extra Dry — Costaross, Veneto, IT (Glera)","Prosecco Extra Dry — Costaross, Veneto, IT (Glera)"),
...
D("wine","white","29.00€","0.75 l","Paradigma — Milović, Briska Gora, ME","Paradigma — Milović, Briska Gora, ME"),
...
D("wine","white","59.00€","0.75 l","Livio Felluga Sauvignon — Friuli, IT","Livio Felluga Sauvignon — Friuli, IT"),
...
D("wine","rose","35.00€","0.75 l","Alie Rose — Frescobaldi, Toscana, IT (Syrah, Vermentino)","Alie Rose — Frescobaldi, Toscana, IT (Syrah, Vermentino)"),
...
D("wine","red","28.00€","0.75 l","Status — Milović, Briska Gora, ME (Vranac)","Status — Milović, Briska Gora, ME (Vranac)"),
D("wine","red","42.00€","0.75 l","Status Barrique — Milović, Briska Gora, ME (Vranac)","Status Barrique — Milović, Briska Gora, ME (Vranac)"),
D("wine","red","64.00€","0.75 l","Status Rezerva — Milović, Briska Gora, ME","Status Rezerva — Milović, Briska Gora, ME"),
...
D("wine","champagne","150.00€","0.75 l","Moët & Chandon Impérial Brut — Champagne, FR (Pinot Noir, Pinot Meunier, Chardonnay)","Moët & Chandon Impérial Brut — Champagne, FR (Pinot Noir, Pinot Meunier, Chardonnay)"),
];

const COCKTAILS=[
{cat:"kokteli",price:"11.00 €",img:"images/koktel-pop-the-cork.jpg",t:{me:{n:"POP THE CORK",d:"Освјежавајућа комбинација домаће лозове ракије и вина, упарена са лимончелом. Балансирана свјежом лиметом, слаткоћом карамелизованих кокица и додиром чоколадног битера."},en:{n:"POP THE CORK",d:"A refreshing blend of local grape spirit and wine paired with limoncello. Balanced with fresh lime, caramelized popcorn sweetness and a touch of chocolate bitters."}}},
{cat:"kokteli",price:"12.00 €",img:"images/koktel-amalfi-mule.jpg",t:{me:{n:"AMALFI MULE",d:"Свјеж и благо пикантан коктел, са цитрусним карактером и нотама малине. Освјежавајући mule са џином, завршен cranberry битером."},en:{n:"AMALFI MULE",d:"Fresh and lightly spicy, with bright citrus character and juicy raspberry notes. A refreshing mule with gin, finished with cranberry bitters."}}},
{cat:"kokteli",price:"12.00 €",img:"images/koktel-dark-and-stormy.jpg",t:{me:{n:"DARK AND STORMY",d:"Богат и освјежавајући коктел са балансом топлих зачина и цитруса. Ноте карамеле и меласе, пикантна топлина, слаткоћа ананаса и ванила."},en:{n:"DARK AND STORMY",d:"Rich and refreshing, with warm spice and bright citrus. Caramel and molasses notes, spicy heat softened by pineapple sweetness and vanilla."}}},
{cat:"kokteli",price:"15.00 €",img:"images/koktel-whisky-spectaculoos.jpg",t:{me:{n:"WHISKY SPECTACULOOS",d:"Богат и баршунаст коктел са балансом топлих зачина, цитруса и орашасте слаткоће."},en:{n:"WHISKY SPECTACULOOS",d:"Rich and velvety, with a balance of warming spice, bright citrus and nutty sweetness."}}},
{cat:"kokteli",price:"9.90 €",img:"images/koktel-papa-doble.jpg",t:{me:{n:"PAPA DOBLE",d:"Свијетао, сув и цитрусан коктел, инспирисан Hemingway стилом. Лагани рум, свјежи грејп, лимета, мараскино ликер и сируп од грејпа."},en:{n:"PAPA DOBLE",d:"Bright, dry and citrus-forward, Hemingway-inspired. Light rum, fresh grapefruit, lime, maraschino liqueur and grapefruit syrup."}}},
{cat:"kokteli",price:"12.00 €",img:"images/koktel-margot.jpg",t:{me:{n:"MARGOT",d:"Свијетао и структуриран коктел са класичном margarita свјежином, слојевит уз labdanum cordial и premium ликер од наранџе."},en:{n:"MARGOT",d:"Bright and structured, with classic margarita-style freshness, layered with labdanum cordial and premium orange liqueur."}}},
{cat:"kokteli",price:"12.00 €",img:"images/koktel-mint-to-be-green.jpg",t:{me:{n:"MINT TO BE GREEN",d:"Хрскав и расхлађујући микс џина, свјеже менте, краставца и цитруса, подигнут нотама зове и завршен пјенушавом лимунадом."},en:{n:"MINT TO BE GREEN",d:"A crisp and cooling mix of gin, fresh mint, cucumber and citrus, lifted with elderflower and a sparkling lemonade finish."}}},
...
{cat:"kokteli",price:"10.90 €",img:"images/koktel-moscow-mule.jpg",t:{me:{n:"MOSCOW MULE",d:"Тропска интерпретација класичног Mule коктела: свјежа, пикантна и хрскава, са кућним додиром."},en:{n:"MOSCOW MULE",d:"A tropical take on the classic Mule: crisp and spicy with a signature house touch."}}},
{cat:"kokteli",price:"9.90 €",img:"images/koktel-la-succette.jpg",t:{me:{n:"LA SUCCETTE",d:"Освјежавајућа комбинација вотке инфузиране малином, џина, свјежих малина и менте, балансирана нотама зове."},en:{n:"LA SUCCETTE",d:"A refreshing blend of raspberry-infused vodka, gin, fresh raspberries and mint, balanced with elderflower."}}},
{cat:"kokteli",price:"9.90 €",img:"images/koktel-gin-basil-smash.jpg",t:{me:{n:"GIN BASIL SMASH",d:"Свјеж и цитрусан коктел који спаја џин, кућну есенцију босиљка и свјеже цитрусне сокове."},en:{n:"GIN BASIL SMASH",d:"A fresh, citrus-forward cocktail combining gin, house basil essence and fresh citrus juices."}}},
{cat:"kokteli",price:"12.00 €",img:"images/koktel-margot-pink-again.jpg",t:{me:{n:"MARGOT GOES PINK AGAIN",d:"Лаган, пјенушав и цитрусан Paloma twist са освјежавајућом горко-слатком ивицом."},en:{n:"MARGOT GOES PINK AGAIN",d:"Light, sparkling and citrus-driven Paloma twist with a refreshing bittersweet edge."}}},
{cat:"kokteli",price:"12.00 €",img:"images/koktel-bruja-dorada.jpg",t:{me:{n:"BRUJA DORADA",d:"Тропски и цитрусан коктел са хербално-цвјетном комплексношћу. Текила, свјежа лимета и ананас, есенција лаванде и ноте вермута."},en:{n:"BRUJA DORADA",d:"Tropical and citrus-forward, with soft herbal floral complexity. Tequila, fresh lime and pineapple, lavender essence and vermouth notes."}}},
{cat:"kokteli",price:"11.00 €",img:"images/koktel-sexpresso-rumtini.jpg",t:{me:{n:"SEXPRESSO RUMTINI",d:"Кућни twist на Espresso Martini, обогаћен есенцијом speculoos бисквита — цимет, смеђи шећер и печени зачини."},en:{n:"SEXPRESSO RUMTINI",d:"A house twist on Espresso Martini, elevated with speculoos biscuit essence — cinnamon, brown sugar and baked spice."}}},
{cat:"kokteli",price:"12.00 €",img:"images/koktel-error-404.jpg",t:{me:{n:"ERROR 404: MARTINI NOT FOUND",d:"Структуриран и ароматичан коктел на бази џина. Blood orange gin, premium ликер од наранџе, supasawa, кућни рузмарин и слатки вермут."},en:{n:"ERROR 404: MARTINI NOT FOUND",d:"A structured, aromatic gin-based cocktail. Blood orange gin, premium orange liqueur, supasawa, house rosemary and sweet vermouth."}}},
...
{cat:"kokteli",price:"9.90 €",img:"images/koktel-mind-games.jpg",t:{me:{n:"MIND GAMES",d:"Лаган, ароматичан и освјежавајући коктел на бази вина, са медитеранским хербалним профилом (лаванда и labdanum)."},en:{n:"MIND GAMES",d:"Light, aromatic and refreshing wine-based cocktail, with a Mediterranean herbal profile of lavender and labdanum."}}},
{cat:"kokteli",price:"9.90 €",img:"images/koktel-pear-punch.jpg",t:{me:{n:"PEAR PUNCH",d:"Лаган, хрскав и воћан коктел. Вотка инфузирана крушком, свјежи сок од крушке, Sauvignon, лимун и цвјетна арома јасмина."},en:{n:"PEAR PUNCH",d:"Light, crisp and fruity. Pear-infused vodka, fresh pear juice, Sauvignon, lemon and delicate jasmine aromatics."}}},
{cat:"kokteli",price:"9.90 €",img:"images/koktel-limoncello-spritz.jpg",t:{me:{n:"LIMONCELLO SPRITZ",d:"Свијетао, пјенушав и интензивно цитрусан класик, подигнут cordialom од Timur бобица."},en:{n:"LIMONCELLO SPRITZ",d:"Bright, sparkling and intensely citrus-forward classic, elevated with a touch of Timur berry cordial."}}},
...
{cat:"kokteli",price:"9.00 €",img:"images/koktel-strawberry-basil-lemonade.jpg",t:{me:{n:"STRAWBERRY BASIL LEMONADE",d:"Безалкохолно. Свјеже јагоде, босиљак и цитрусни сок, допуњени содом — лагано љетње пиће."},en:{n:"STRAWBERRY BASIL LEMONADE",d:"Non-alcoholic. Fresh strawberries, basil and citrus juice, topped with soda — a light summer drink."}}},
];
